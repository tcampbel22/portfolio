	...
	return (
		<div className='mt-10 mb-10 pb-10'>
			...
			<div className='grid grid-cols-1 lg:grid-cols-2 gap-10 p-5 m-5 '>
				<Project projectName="Custom shell interpreter" link="https://github.com/tcampbel22/custom_shell_interpreter" image="/shell.gif"/>
				...
				<Project projectName="HTTP 1.1 server" link="https://github.com/tcampbel22/HTTP_1.1_server" image="/server.gif"/>
			</div>
