...
import { HeaderSmall } from './HeaderText';

export const About:React.FC = () => {
	return (
		<div className=' p-2 mx-auto py-8'>
			<div className='grid grid-cols-3 justify-items-center'>
				<img src={timImg} className='col-span-3 md:row-span-3 md:col-span-1 w-60 w-60 md:w-90 md:h-90 rounded-lg mt-2'/>
				<p className='col-span-3 md:pt-0 py-6 px-2 md:col-span-2 dark:text-white text-center md:text-left text-md md:text-lg'>
					...
					<p className='col-span-3 md:col-span-2 px-2 dark:text-white text-center md:text-left text-md md:text-lg '>My current toolbox 
